...
import {
  ArrowRight, ChevronDown, CheckCircle2, Clock,
  User, Tag, Search, BookOpen, ChevronRight,
} from "lucide-react"
...
// ─── ALL IMAGES FIXED — UNIQUE UNSPLASH URLs ─────────────────────────────────
const articles = [
  {
    id: 1, slug: "best-marble-for-home-flooring",
    title: "Best Marble for Home Flooring",
    excerpt: "Choosing the right marble for your home flooring can be overwhelming. We break down the top varieties — from classic Makrana White to luxurious Calacatta Gold — and explain what suits each space best.",
    // ✅ Unique: marble floor close-up
    image: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&q=80",
    category: "Marble Guides", author: "Dayanand Marbles", date: "March 2, 2025", readTime: "5 min read", featured: true,
  },
  {
    id: 2, slug: "marble-vs-granite-comparison",
    title: "Marble vs Granite: Which is Right for You?",
    excerpt: "Both marble and granite are stunning natural stones, but they differ in durability, maintenance, and aesthetics. Here's a complete side-by-side comparison to help you decide.",
    // ✅ Your local granite image — already exists!
    image: "/images/granite.jpg",
    category: "Comparisons", author: "Dayanand Marbles", date: "February 18, 2025", readTime: "7 min read", featured: false,
  },
  {
    id: 3, slug: "how-to-maintain-marble-floors",
    title: "How to Maintain Marble Floors",
    excerpt: "Marble is timeless but requires care. Learn professional maintenance tips — from daily cleaning to deep polishing — that will keep your marble floors gleaming for decades.",
    // ✅ Unique: marble floor maintenance / cleaning
    image: "https://images.unsplash.com/photo-1631679706909-1844bbd07221?w=800&q=80",
    category: "Care & Maintenance", author: "Dayanand Marbles", date: "February 5, 2025", readTime: "6 min read", featured: false,
  },
  {
    id: 4, slug: "top-interior-marble-design-ideas",
    title: "Top Interior Marble Design Ideas for 2025",
    excerpt: "From dramatic marble accent walls to book-matched slabs in living rooms, discover the most inspiring interior design trends using natural stone this year.",
    // ✅ Unique: luxury marble interior living room
    image: "https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?w=800&q=80",
    category: "Design Inspiration", author: "Dayanand Marbles", date: "January 22, 2025", readTime: "8 min read", featured: false,
  },
  {
    id: 5, slug: "italian-marble-guide",
    title: "A Complete Guide to Italian Marble",
    excerpt: "Carrara, Calacatta, Statuario — Italian marble varieties each carry a unique character. Explore the world of Italian stone and find out which quarry produces your perfect slab.",
    // ✅ Your local italian marble image — already exists!
    image: "/images/italian-marble.jpg",
    category: "Marble Guides", author: "Dayanand Marbles", date: "January 10, 2025", readTime: "9 min read", featured: false,
  },
  {
    id: 6, slug: "granite-kitchen-countertops",
    title: "Why Granite is Perfect for Kitchen Countertops",
    excerpt: "Heat-resistant, scratch-proof, and endlessly beautiful — granite is the undisputed king of kitchen countertops. Here's everything you need to know before choosing your slab.",
    // ✅ Unique: granite kitchen countertop
    image: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&q=80",
    category: "Granite Guides", author: "Dayanand Marbles", date: "December 28, 2024", readTime: "5 min read", featured: false,
  },
]
  ...
  return (
    <>
      <style>{`
        ...
        .blog-root { color:var(--text); background:var(--cream); }
        ...
        .hero-search { display:flex;align-items:center;background:rgba(255,255,255,.88);backdrop-filter:blur(8px);border:1px solid rgba(140,107,74,.2);border-radius:100px;padding:6px 6px 6px 24px;max-width:460px;margin:0 auto;opacity:0;animation:fadeIn .9s ease .8s forwards; }
        .hero-search input { flex:1;border:none;background:transparent;font-size:14px;color:var(--dark);outline:none;padding:8px 0; }
        .hero-search input::placeholder { color:var(--muted); }
        .hero-search-btn { display:flex;align-items:center;justify-content:center;width:44px;height:44px;border-radius:100px;background:var(--dark);color:#fff;border:none;cursor:pointer;transition:background .25s;flex-shrink:0; }
        ...
        .featured-card { display:grid;grid-template-columns:1.2fr 0.8fr;border-radius:6px;overflow:hidden;box-shadow:0 24px 72px rgba(0,0,0,.1); }
        ...
        .feat-img-wrap img { position:absolute;inset:0;width:100%;height:100%;object-fit:cover;transition:transform .8s cubic-bezier(.25,.46,.45,.94); }
        .featured-card:hover .feat-img-wrap img { transform:scale(1.04); }
        .feat-img-wrap::after { content:'';position:absolute;inset:0;background:linear-gradient(to top,rgba(28,26,23,.5) 0%,transparent 60%); }
        .feat-badge { position:absolute;top:24px;left:24px;z-index:2;background:var(--brown);color:#fff;border-radius:100px;padding:5px 16px;font-size:10px;letter-spacing:.16em;text-transform:uppercase; }
        .feat-body { background:var(--dark);padding:56px 48px;display:flex;flex-direction:column;justify-content:center; }
        .feat-cat { font-size:11px;letter-spacing:.16em;text-transform:uppercase;color:var(--stone);margin-bottom:16px; }
        .feat-title { font-size:clamp(26px,3vw,36px);font-weight:700;color:#fff;line-height:1.15;margin-bottom:20px; }
        ...
        .content-wrap { max-width:1200px;margin:0 auto;padding:0 32px;display:grid;grid-template-columns:1fr 320px;gap:48px;align-items:start; }
        ...
        .filter-pill { padding:8px 18px;border-radius:100px;font-size:11px;letter-spacing:.12em;text-transform:uppercase;border:1px solid rgba(196,180,154,.4);background:transparent;color:var(--muted);cursor:pointer;transition:background .25s,color .25s,border-color .25s; }
        ...
        .blog-card { background:#fff;border-radius:6px;overflow:hidden;transition:box-shadow .35s,transform .35s;cursor:pointer; }
        .blog-card:hover { box-shadow:0 16px 48px rgba(0,0,0,.1);transform:translateY(-4px); }

        /* CARD IMAGE — using <img> tag so no next/image config needed */
        .blog-card-img { position:relative;aspect-ratio:16/10;overflow:hidden; }
        .blog-card-img img { width:100%;height:100%;object-fit:cover;display:block;transition:transform .8s cubic-bezier(.25,.46,.45,.94); }
        .blog-card:hover .blog-card-img img { transform:scale(1.06); }
        .blog-card-cat { position:absolute;top:14px;left:14px;background:rgba(249,246,241,.9);backdrop-filter:blur(4px);border-radius:100px;padding:4px 12px;font-size:10px;letter-spacing:.14em;text-transform:uppercase;color:var(--brown); }

        .blog-card-body { padding:28px; }
        .blog-card-title { font-size:22px;font-weight:400;font-style:italic;color:var(--dark);line-height:1.2;margin-bottom:10px;transition:color .2s; }
        .blog-card:hover .blog-card-title { color:var(--brown); }
        .blog-card-excerpt { font-size:13px;line-height:1.85;color:var(--muted);margin-bottom:20px; }
        .blog-card-meta { display:flex;align-items:center;gap:16px;padding-top:16px;border-top:1px solid rgba(196,180,154,.2); }
        ...
        .blog-read-link { margin-left:auto;display:flex;align-items:center;gap:4px;font-size:11px;letter-spacing:.1em;text-transform:uppercase;color:var(--brown);text-decoration:none;transition:gap .2s; }
        .blog-card:hover .blog-read-link { gap:8px; }

        .empty-state { grid-column:1/-1;text-align:center;padding:64px 0;color:var(--muted);font-size:15px;line-height:1.8; }
        .empty-state-title { font-size:32px;font-weight:400;font-style:italic;color:var(--dark);margin-bottom:12px; }

        /* SIDEBAR */
        .sidebar { display:flex;flex-direction:column;gap:32px; }
        .sidebar-widget { background:#fff;border-radius:6px;padding:32px;overflow:hidden;position:relative; }
        .sidebar-widget::before { content:'';position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,var(--stone),var(--brown),var(--stone));background-size:200% 100%;animation:shimmer 3s ease infinite; }
        .sidebar-widget-title { font-size:22px;font-weight:400;font-style:italic;color:var(--dark);margin-bottom:24px;padding-bottom:14px;border-bottom:1px solid rgba(196,180,154,.25); }

        .cat-list { display:flex;flex-direction:column; }
        .cat-item { display:flex;justify-content:space-between;align-items:center;padding:12px 0;border-bottom:1px solid rgba(196,180,154,.15);cursor:pointer;transition:color .2s;font-size:14px;color:var(--text);text-decoration:none; }
        .cat-item:hover { color:var(--brown); }
        .cat-item:last-child { border-bottom:none; }
        .cat-count { font-size:11px;font-weight:500;color:var(--muted);background:var(--warm);border-radius:100px;padding:2px 10px; }
        ...
        .recent-thumb { position:relative;width:64px;height:64px;border-radius:4px;overflow:hidden;flex-shrink:0; }
        .recent-thumb img { width:100%;height:100%;object-fit:cover;transition:transform .4s; }
        .recent-item:hover .recent-thumb img { transform:scale(1.08); }
        .recent-info { flex:1; }
        .recent-title { font-size:16px;font-weight:400;font-style:italic;color:var(--dark);line-height:1.25;margin-bottom:4px;transition:color .2s; }
        .recent-item:hover .recent-title { color:var(--brown); }
        .recent-date { font-size:11px;color:var(--muted); }

        .sidebar-search { display:flex;align-items:center;background:var(--warm);border:1px solid rgba(196,180,154,.3);border-radius:100px;padding:4px 4px 4px 18px; }
        .sidebar-search input { flex:1;border:none;background:transparent;font-size:13px;color:var(--dark);outline:none;padding:8px 0; }
        .sidebar-search input::placeholder { color:var(--muted); }
        .sidebar-search-btn { width:36px;height:36px;border-radius:100px;background:var(--dark);color:#fff;border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:background .25s; }
        .sidebar-search-btn:hover { background:var(--brown); }

        .cta-widget { background:var(--dark);border-radius:6px;padding:36px 28px;text-align:center;position:relative;overflow:hidden; }
        .cta-widget-title { font-size:24px;font-weight:400;color:#fff;line-height:1.2;margin-bottom:12px; }
        ...
        .cta-widget-btn { display:inline-flex;align-items:center;gap:8px;background:var(--brown);color:#fff;padding:12px 24px;border-radius:100px;font-size:11px;letter-spacing:.12em;text-transform:uppercase;text-decoration:none;transition:background .25s,transform .2s; }
        ...
        .newsletter-title { font-size:clamp(32px,5vw,48px);font-weight:700;color:var(--dark);margin-bottom:16px; }
        .newsletter-title em { font-style:italic;font-weight:400;color:var(--brown); }
        .newsletter-desc { font-size:15px;line-height:1.75;color:var(--muted);margin-bottom:36px; }
        .newsletter-form { display:flex;background:#fff;border:1px solid rgba(196,180,154,.3);border-radius:100px;padding:6px 6px 6px 24px; }
        .newsletter-form input { flex:1;border:none;background:transparent;font-size:14px;color:var(--dark);outline:none;padding:10px 0; }
        .newsletter-form input::placeholder { color:var(--muted); }
        .newsletter-submit { display:inline-flex;align-items:center;gap:8px;background:var(--dark);color:#fff;padding:12px 24px;border-radius:100px;font-size:11px;letter-spacing:.12em;text-transform:uppercase;border:none;cursor:pointer;white-space:nowrap;transition:background .25s; }
      ...
      <div className="blog-root">
        ...
        <section className="hero">
          ...
          <div className="hero-content">
            ...
            <p className="hero-desc" style={{ opacity:heroVisible?1:0, transform:heroVisible?"translateY(0)":"translateY(20px)", transition:"opacity .9s ease .6s,transform .9s ease .6s" }}>
              Expert insights, design inspiration and stone care guides — straight from Rajasthan's most trusted marble specialists.
            </p>
            ...
            <Reveal delay={0.1} className="featured-wrap">
              <div className="featured-card">
                ...
                <div className="feat-body">
                  ...
                  <Link href={`/blog/${featured.slug}`} className="feat-link">Read Article <ArrowRight size={13} /></Link>
                </div>
              </div>
            </Reveal>
          </section>
                    ...
                    <Link href={`/blog/${article.slug}`} style={{ textDecoration:"none" }}>
                      <div className="blog-card">
                        <div className="blog-card-img">
                          {/* ✅ Using <img> tag — works with both local and Unsplash URLs */}
            ...
            <aside className="sidebar">
              ...
              <Reveal delay={0.05}>
                <div className="sidebar-widget">
                  ...
                  <div className="cat-list">
                    {categories.map(cat => (
                      <span key={cat.name} className="cat-item" onClick={() => setActiveCategory(cat.name)}>
                        {cat.name}
                    ...
                    {recentPosts.map(post => (
                      <Link key={post.id} href={`/blog/${post.slug}`} className="recent-item">
                        <div className="recent-thumb">
                          {/* ✅ Using <img> tag for recent post thumbnails */}
              ...
              <Reveal delay={0.15}>
                <div className="cta-widget">
                  ...
                  <div className="cta-widget-title">Need Premium <em>Stone?</em></div>
                  <p className="cta-widget-desc">Our experts are ready to help you find the perfect marble or granite for your project.</p>
                  <Link href="/contact" className="cta-widget-btn">Get in Touch <ArrowRight size={14} /></Link>
                </div>
              </Reveal>
            </aside>
          </div>
        ...
        <section className="newsletter-section">
          <Reveal className="newsletter-inner">
            ...
            <h2 className="newsletter-title">Subscribe to Our <em>Newsletter</em></h2>
            <p className="newsletter-desc">Get the latest marble care tips, design trends, and exclusive product guides delivered straight to your inbox — no spam, ever.</p>
        ...
        <section className="cta-section">
          ...
          <Reveal className="cta-inner">
            ...
            <h2 className="cta-title">Bring Your Vision<br /><em>to Life</em></h2>
            <p className="cta-desc">Browse our extensive collection of premium marbles, granites, and tiles. Let us help you select the perfect stone for your next project.</p>
