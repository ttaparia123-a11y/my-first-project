  ...
  return (
    <>
      <style>{`
        ...
        .ct-root{ font-family:'Jost',sans-serif; color:var(--text); background:var(--cream); }
        ...
        .info-body{}
        .info-title{ font-family:'Cormorant Garamond',serif; font-size:18px; font-weight:600; color:var(--dark); margin-bottom:6px; }
        .info-line{ font-size:13px; line-height:1.7; color:var(--muted); }
        ...
        .form-title{ font-family:'Cormorant Garamond',serif; font-size:32px; font-weight:600; color:var(--dark); margin-bottom:8px; }
        .form-subtitle{ font-size:14px; color:var(--muted); margin-bottom:36px; }

        .form-row{ display:grid; grid-template-columns:1fr 1fr; gap:16px; }
        @media(max-width:560px){ .form-row{grid-template-columns:1fr;} }

        .field{ display:flex; flex-direction:column; gap:6px; margin-bottom:16px; }
        .field label{ font-size:11px; letter-spacing:.12em; text-transform:uppercase; color:var(--muted); font-weight:500; }
        .field input,
        .field textarea,
        .field select{
        ...
        .success-title{ font-family:'Cormorant Garamond',serif; font-size:32px; font-weight:600; color:var(--dark); }
        .success-desc{ font-size:14px; line-height:1.8; color:var(--muted); max-width:320px; }
        ...
        .map-overlay-name{
          font-family:'Cormorant Garamond',serif;
          font-size:20px; font-weight:600; color:var(--dark); margin-bottom:6px;
        }
        .map-overlay-addr{ font-size:13px; color:var(--muted); line-height:1.6; }
        .map-overlay-link{
        ...
        .visit-section::before{
          ...
          font-family:'Cormorant Garamond',serif;
          font-size:420px; font-weight:700; color:rgba(255,255,255,.02);
        ...
        .visit-dot{
          width:10px; height:10px; border-radius:50%; background:var(--brown); flex-shrink:0;
        }
        .visit-label{ font-size:13px; color:rgba(255,255,255,.7); }
          ...
          <div className="contact-wrap">
            ...
            <div className="contact-grid">
              ...
              <Reveal className="info-cards" delay={0.05}>
                ...
                {/* Social icons */}
                <div>
                  <div style={{ fontSize:11, letterSpacing:"0.14em", textTransform:"uppercase", color:"var(--muted)", marginBottom:12 }}>
                    Follow Us
                  </div>
        ...
        <section className="map-section">
          <div className="map-wrap">
            <Reveal className="map-header">
              ...
              <p style={{ marginTop:12, fontSize:15, lineHeight:1.75, color:"var(--muted)", maxWidth:480 }}>
            ...
            <Reveal delay={0.1}>
              <div className="map-container">
                {/* Google Maps embed — Udaipur, Rajasthan */}
                <iframe
