...
───────────────────────────────────────── */
const projects = [
  { id:1,  title:"Luxury Villa Flooring",   category:"flooring",  image:"/images/portfolio/flooring-1.jpg",  description:"Premium Italian marble flooring installation" },
  { id:2,  title:"Modern Bathroom Walls",   category:"walls",     image:"/images/portfolio/wall-1.jpg",      description:"Floor-to-ceiling marble wall design" },
  { id:3,  title:"Grand Staircase",         category:"interiors", image:"/images/portfolio/staircase-1.jpg", description:"Elegant marble staircase with custom detailing" },
  { id:4,  title:"Kitchen Countertop",      category:"kitchens",  image:"/images/portfolio/kitchen-1.jpg",   description:"Calacatta marble kitchen island" },
  { id:5,  title:"Living Room Interior",    category:"interiors", image:"/images/portfolio/interior-1.jpg",  description:"Complete marble interior transformation" },
  { id:6,  title:"Hotel Lobby Flooring",    category:"flooring",  image:"/images/portfolio/flooring-2.jpg",  description:"Geometric marble floor pattern" },
  { id:7,  title:"Granite Kitchen",         category:"kitchens",  image:"/images/portfolio/kitchen-2.jpg",   description:"Premium granite countertop installation" },
  { id:8,  title:"Marble Feature Wall",     category:"walls",     image:"/images/portfolio/wall-1.jpg",      description:"Statement wall in residential project" },
]
...
const testimonials = [
  { id:1, name:"Rajesh Mehta",      role:"Homeowner, Udaipur",       rating:5,
    text:"Dayanand Marbles transformed our living room beyond imagination. The quality of the Calacatta marble was impeccable and the team was incredibly professional.",
    project:"Luxury Villa Flooring" },
  { id:2, name:"Priya Sharma",      role:"Interior Designer, Jaipur", rating:5,
    text:"I've collaborated on over 15 projects with Dayanand Marbles. Their stone selection is unmatched in Rajasthan and ability to deliver on tight deadlines sets them apart.",
    project:"Hotel Lobby Flooring" },
  { id:3, name:"Arjun Singhania",   role:"Builder, Jodhpur",          rating:5,
    text:"For our premium residential complex they supplied over 5000 sq ft of granite flooring. Flawless quality, competitive pricing, on-time delivery — exactly what we needed.",
    project:"Granite Kitchen" },
]
  ...
  return (
    <>
      <style>{`
        ...
        .pr { font-family:'Jost',sans-serif; color:var(--text); background:var(--cream); }
        ...
        /* ✅ marble-texture.jpg — same as Products / Services / About */
        .hero-bg{
        ...
        .stat-value{
          font-family:'Cormorant Garamond',serif;
          font-size:36px;font-weight:600;color:var(--stone);line-height:1;margin-bottom:4px;
        }
        ...
        .feat-img-wrap{position:relative;min-height:500px;}
        .feat-img-wrap img{object-fit:cover;}
        .feat-img-wrap::after{
          content:'';position:absolute;inset:0;
          background:linear-gradient(to right,transparent 60%,rgba(28,26,23,.3));
        }
        .feat-label{
          position:absolute;top:28px;left:28px;
          background:rgba(255,255,255,.88);backdrop-filter:blur(8px);
          border:1px solid rgba(140,107,74,.2);border-radius:100px;
          padding:5px 16px;font-size:10px;letter-spacing:.16em;text-transform:uppercase;color:var(--brown);
        }
        .feat-body{
        ...
        .feat-yr{
          font-family:'Cormorant Garamond',serif;
          font-size:80px;font-weight:700;color:rgba(255,255,255,.04);line-height:1;margin-bottom:-16px;
        }
        .feat-title{
          font-family:'Cormorant Garamond',serif;
          font-size:28px;font-weight:600;color:#fff;line-height:1.2;margin-bottom:8px;
        }
        ...
        .spec-lbl{font-size:11px;letter-spacing:.12em;text-transform:uppercase;color:rgba(255,255,255,.3);}
        ...
        .filter-bar{
          ...
          background:rgba(249,246,241,.93);backdrop-filter:blur(12px);
          border-bottom:1px solid rgba(196,180,154,.25);
        }
        .filter-inner{
        ...
        .filter-btn{
          ...
          cursor:pointer;white-space:nowrap;transition:color .25s;
        }
        .filter-btn::after{
          content:'';position:absolute;bottom:0;left:50%;right:50%;
          height:2px;background:var(--brown);transition:left .3s ease,right .3s ease;
        }
        ...
        .masonry-overlay{
          position:absolute;inset:0;
          background:linear-gradient(to top,rgba(28,26,23,.82) 0%,rgba(28,26,23,0) 55%);
        ...
        .masonry-cat{
          font-size:10px;letter-spacing:.16em;text-transform:uppercase;color:var(--stone);margin-bottom:5px;
          transform:translateY(8px);opacity:0;transition:opacity .35s ease .05s,transform .35s ease .05s;
        }
        .masonry-item:hover .masonry-cat{opacity:1;transform:translateY(0);}
        .masonry-title{
          font-family:'Cormorant Garamond',serif;
          font-size:22px;font-weight:600;color:#fff;line-height:1.1;
          transform:translateY(8px);opacity:0;transition:opacity .35s ease .1s,transform .35s ease .1s;
        }
        ...
        .lb-info{
          ...
          background:linear-gradient(to top,rgba(28,26,23,.9),transparent);
          padding:32px 24px 20px;border-radius:0 0 4px 4px;text-align:center;
        }
        .lb-title{font-family:'Cormorant Garamond',serif;font-size:26px;font-weight:600;color:#fff;margin-bottom:4px;}
        ...
        .lb-counter{
          ...
          font-size:11px;letter-spacing:.16em;color:rgba(255,255,255,.35);text-transform:uppercase;
        }
        ...
        .process-card{
          background:var(--cream);border-radius:12px;padding:36px 28px;text-align:center;
          transition:box-shadow .3s,transform .3s;
        }
        .process-card:hover{box-shadow:0 12px 40px rgba(0,0,0,.08);transform:translateY(-4px);}
        .process-num{
          font-family:'Cormorant Garamond',serif;
          font-size:52px;font-weight:700;color:var(--stone);opacity:.3;line-height:1;margin-bottom:-8px;
        }
        .process-title{
          font-family:'Cormorant Garamond',serif;
        ...
        .testi-section::before{
          ...
          font-family:'Cormorant Garamond',serif;
          font-size:600px;font-weight:700;color:rgba(255,255,255,.02);
          top:-60px;left:40px;line-height:1;pointer-events:none;
        }
        ...
        .testi-name{font-family:'Cormorant Garamond',serif;font-size:18px;font-weight:600;color:#fff;margin-bottom:4px;}
        ...
        .client-card{
          background:#fff;border:1px solid rgba(196,180,154,.25);
        ...
        .client-icon{
          ...
          background:var(--warm);border:1px solid rgba(196,180,154,.35);
        ...
        .client-title{
          font-family:'Cormorant Garamond',serif;
          font-size:22px;font-weight:600;color:var(--dark);margin-bottom:10px;
        }
        .client-desc{font-size:13px;line-height:1.8;color:var(--muted);}
      ...
      <div className="pr">
        ...
        {/* ── HERO ── marble-texture.jpg, same vignette as Products/Services/About */}
        <section className="hero">
          ...
          <div className="hero-content">
            ...
            <p className="hero-desc"
              ...
              Explore our finest marble and granite installations across residential and
              commercial spaces — each project a testament to timeless craftsmanship.
            </p>
          ...
          <Reveal delay={0.1} className="featured-wrap">
            <div className="featured-card">
              <div className="feat-img-wrap">
                <Image src={featuredProject.image} alt={featuredProject.title} fill />
        ...
        <div className="filter-bar" id="gallery">
          <div className="filter-inner">
            {categories.map(cat => (
              <button key={cat.id} className={`filter-btn ${activeCategory===cat.id?"active":""}`}
                onClick={() => handleFilter(cat.id)}>{cat.label}</button>
            ))}
          </div>
        </div>
        ...
        <section className="gallery-section">
          <div className="gallery-inner">
            <div className="masonry-grid" style={{ opacity:filterChanging?0:1, transition:"opacity .28s ease" }}>
              {filtered.map((p, i) => (
                <div key={`${p.id}-${activeCategory}`} className="masonry-item"
                  style={{ animationDelay:`${i*.06}s` }}
                  onClick={() => openLightbox(i)}>
                  <Image src={p.image} alt={p.title} width={600}
                    height={i%3===0?800:i%2===0?500:620} className="masonry-img" />
        ...
        {lightboxOpen && (
          <div className="lb-backdrop" onClick={closeLightbox}>
            <div className="lb-content" onClick={e => e.stopPropagation()}>
              ...
              <Image key={currentImage} src={filtered[currentImage].image}
                alt={filtered[currentImage].title} width={1200} height={800}
                className="lb-img" style={{ animation:"lbIn .3s ease" }} />
                ...
                <Reveal key={t.id} delay={i*.1}>
                  <div className="testi-card">
                    ...
                    <div className="testi-stars">
                      {Array.from({length:t.rating}).map((_,j) => <Star key={j} size={14} />)}
                    </div>
        ...
        <section className="cta-section">
          ...
          <Reveal className="cta-inner">
            ...
            <p className="cta-desc">
              Contact us today to discuss your vision. Our team of experts is ready to help
              you create stunning marble and granite installations.
            </p>
