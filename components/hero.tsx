      ...
      <div className="relative z-20 container mx-auto px-6 pt-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm font-medium text-marble-brown tracking-wide">
              20+ Years of Excellence
            </span>
          </div>

          {/* Main Heading with blur reveal animation */}
          <h1
            className={`font-serif text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-semibold leading-tight mb-6 transition-all duration-1000 delay-200 ${
              isVisible
          ...
          >
            ...
            <br />
            <span className="text-marble-brown">Natural Stone</span>
          </h1>
         ...
         >
          ...
          >
            <div className="text-center">
              <div className="font-serif text-4xl md:text-5xl font-semibold text-marble-brown mb-2">
                20+
              </div>
